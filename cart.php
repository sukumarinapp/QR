  ...
  <body class="bg-light text-black">
   ...
   <a class="navbar-brand font-weight-bold" href="#"><?php echo $comnam; ?></a>
    ...
    <nav class="navbar fixed-bottom navbar-expand-lg bg-info">
      <a class="btn btn-sm btn-danger font-weight-bold" href="menu.php?center_id=<?php echo $hotel_id; ?>&table_id=<?php echo $tblnub; ?>" >Menu</a>
      <?php if($payment_type==3){ ?>
      <a style="text-align: right" class="btn btn-sm btn-danger font-weight-bold" href="pay.php?hotel_id=<?php echo $hotel_id; ?>&oid=<?php echo $order_id; ?>" >Checkout</a>
      <?php } ?>  
      <?php
