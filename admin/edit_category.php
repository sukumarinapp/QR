...
if (isset($_POST['submit'])) {
	...
	$status = trim($_POST['status']);
        ...
        $stmt = $conn->prepare("UPDATE category  set category_name=?,category_description=?,status=? where id=?");
        $stmt->bind_param("ssss",$category_name, $category_description,$status,$id);
        $stmt->execute();
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input value="<?php echo $row['category_name']; ?>" required="required" type="text"
                                                       maxlength="50"
											...
											<div class="form-group">
                                                ...
                                                <input value="<?php echo $row['category_description']; ?>" required="required" type="text"
                                                       maxlength="100"
