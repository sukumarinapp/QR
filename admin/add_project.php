...
if (isset($_POST['submit'])) {
    ...
    $pricing= trim($_POST['pricing']);
        ...
        $stmt = $conn->prepare("INSERT INTO project (center_id,category_id,project_name,description,pricing,status) VALUES (?,?,?,?,?,?)");
        $stmt->bind_param("ssssss", $center_id,$category_id,$project_name,$description,$pricing,$status);
                  ...
                  <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h1 class="panel-title">Add Menu</h1>
                            </div>
...
?>
											...
											<div class="form-group">
                                                <label for="project_name required" class="control-label required">Menu Name</label>
                                                <input value="<?php echo $project_name; ?>" required "required" type="text" maxlength="50" name="project_name" id="project_name" class="form-control" placeholder="Menu Name">
                                            </div>
											<div class="form-group">
